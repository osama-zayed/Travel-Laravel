...
<div class="page-header">
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">{{__('admin.createPlane')}}</h2>
                <p class="card-description"> Plane </p>
                <form method="post" action="{{route('admin.plane_1.store')}}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="model" class="col-sm-3 col-form-label">{{__('admin.model')}}</label>
                          <input type="text" class="form-control"   id="model" name="model" placeholder="{{__('admin.model')}}">
                          @error('model')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
                        ...
                        <label for="first_class" class="col-sm-3 col-form-label">{{__('admin.first_class')}}</label>
                          <input type="number" class="form-control"  id="first_class"  name="first_class" placeholder="{{__('admin.first_class')}}" >
                          @error('first_class')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
                        ...
                        <label for="business_class" class="col-sm-3 col-form-label">{{__('admin.business_class')}}</label>
                          <input type="number" class="form-control"  id="business_class"  name="business_class" placeholder="{{__('admin.business_class')}}" >
                        ...
                        <label for="economy_class" class="col-sm-3 col-form-label">{{__('admin.economy_class')}}</label>
                          <input type="number"class="form-control"   id="economy_class"  name="economy_class" placeholder="{{__('admin.economy_class')}}">
                          @error('economy_class')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
